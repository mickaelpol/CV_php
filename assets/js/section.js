...
$(document).ready(function () {
    ...
    function loadSwitch(cont1, cont2, cont3, cont4, cont5, cont6) {
        ...
        $('a').click(function (e) {
            ...
            switch (this.className) {
                ...
                case 'dipClick':
                    ...
                    // si le bouton proClick est cliquer
                case 'proClick':
                    ...
                    // si le bouton contactClick est cliquer
                case 'contactClick':
    ...
    loadSwitch(home, comp, xp, dip, pro, con);
